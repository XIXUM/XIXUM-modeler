...
public class AttributesImpl extends MinimalEObjectImpl.Container implements Attributes
{
   ...
   * @generated
   */
  public NotificationChain basicSetKey(Token newKey, NotificationChain msgs)
  {
    Token oldKey = key;
    key = newKey;
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, TexDslPackage.ATTRIBUTES__KEY, oldKey, newKey);
   ...
   */
  @Override
  public void setKey(Token newKey)
  {
    if (newKey != key)
    {
      NotificationChain msgs = null;
      if (key != null)
        msgs = ((InternalEObject)key).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - TexDslPackage.ATTRIBUTES__KEY, null, msgs);
      if (newKey != null)
        msgs = ((InternalEObject)newKey).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - TexDslPackage.ATTRIBUTES__KEY, null, msgs);
      msgs = basicSetKey(newKey, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, TexDslPackage.ATTRIBUTES__KEY, newKey, newKey));
  }
