...
public class TexDslGrammarAccess extends AbstractElementFinder.AbstractGrammarElementFinder {
	...
	public class AttributesElements extends AbstractParserRuleElementFinder {
		...
		private final RuleCall cKeyTokenParserRuleCall_0_0 = (RuleCall)cKeyAssignment_0.eContents().get(0);
		private final Group cGroup_1 = (Group)cGroup.eContents().get(1);
		...
		//Token
		public RuleCall getKeyTokenParserRuleCall_0_0() { return cKeyTokenParserRuleCall_0_0; }
	...
	//    (ALPHA | SYMBOL) (ALPHA |SYMBOL | NUMERIC)*
	//;
