 ...
 */
package org.xixum.modelerc.docgen.template.ide.contentassist.antlr;
...
import org.xixum.modelerc.docgen.template.ide.contentassist.antlr.internal.InternalTemplateParser;
...
public class TemplateParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, TemplateGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getRichStringIfAccess().getAlternatives_4(), "rule__RichStringIf__Alternatives_4");
			builder.put(grammarAccess.getRichStringElseIfAccess().getAlternatives_4(), "rule__RichStringElseIf__Alternatives_4");
			...
			builder.put(grammarAccess.getTemplateFileAccess().getGroup(), "rule__TemplateFile__Group__0");
			builder.put(grammarAccess.getTemplateFileAccess().getGroup_2(), "rule__TemplateFile__Group_2__0");
			...
			builder.put(grammarAccess.getRichStringAccess().getGroup_2(), "rule__RichString__Group_2__0");
			...
			builder.put(grammarAccess.getRichStringIfAccess().getGroup_4_1(), "rule__RichStringIf__Group_4_1__0");
			builder.put(grammarAccess.getRichStringElseIfAccess().getGroup(), "rule__RichStringElseIf__Group__0");
			builder.put(grammarAccess.getRichStringElseIfAccess().getGroup_4_1(), "rule__RichStringElseIf__Group_4_1__0");
			...
			builder.put(grammarAccess.getTemplateFileAccess().getPackageAssignment_2_1(), "rule__TemplateFile__PackageAssignment_2_1");
			builder.put(grammarAccess.getTemplateFileAccess().getImportSectionAssignment_3(), "rule__TemplateFile__ImportSectionAssignment_3");
			builder.put(grammarAccess.getTemplateFileAccess().getParamsAssignment_4(), "rule__TemplateFile__ParamsAssignment_4");
			builder.put(grammarAccess.getTemplateFileAccess().getBodyAssignment_5(), "rule__TemplateFile__BodyAssignment_5");
			...
			builder.put(grammarAccess.getParameterAccess().getDefaultexpAssignment_4_1(), "rule__Parameter__DefaultexpAssignment_4_1");
			builder.put(grammarAccess.getRichStringAccess().getExpressionsAssignment_1(), "rule__RichString__ExpressionsAssignment_1");
			builder.put(grammarAccess.getRichStringAccess().getExpressionsAssignment_2_0(), "rule__RichString__ExpressionsAssignment_2_0");
			builder.put(grammarAccess.getRichStringAccess().getExpressionsAssignment_2_1(), "rule__RichString__ExpressionsAssignment_2_1");
			...
			builder.put(grammarAccess.getRichStringForLoopAccess().getEachExpressionAssignment_5(), "rule__RichStringForLoop__EachExpressionAssignment_5");
			...
			builder.put(grammarAccess.getRichStringIfAccess().getElseAssignment_4_0(), "rule__RichStringIf__ElseAssignment_4_0");
			builder.put(grammarAccess.getRichStringIfAccess().getElseAssignment_4_1_1(), "rule__RichStringIf__ElseAssignment_4_1_1");
			builder.put(grammarAccess.getRichStringElseIfAccess().getIfAssignment_2(), "rule__RichStringElseIf__IfAssignment_2");
			builder.put(grammarAccess.getRichStringElseIfAccess().getThenAssignment_3(), "rule__RichStringElseIf__ThenAssignment_3");
			builder.put(grammarAccess.getRichStringElseIfAccess().getElseAssignment_4_0(), "rule__RichStringElseIf__ElseAssignment_4_0");
			builder.put(grammarAccess.getRichStringElseIfAccess().getElseAssignment_4_1_1(), "rule__RichStringElseIf__ElseAssignment_4_1_1");
