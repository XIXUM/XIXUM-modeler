...
public abstract class AbstractTemplateUiModule extends DefaultXbaseWithAnnotationsUiModule {

	public AbstractTemplateUiModule(AbstractUIPlugin plugin) {
		super(plugin);
	}
	...
	public void configureHighlightingLexer(Binder binder) {
		binder.bind(org.eclipse.xtext.parser.antlr.Lexer.class)
			...
			.to(org.xixum.modeler.docgen.template.parser.antlr.internal.InternalTemplateLexer.class);
	}
	...
	public void configureContentAssistLexerProvider(Binder binder) {
		binder.bind(InternalTemplateLexer.class).toProvider(LexerProvider.create(InternalTemplateLexer.class));
	}
	...
	public Class<? extends IssueResolutionProvider> bindIssueResolutionProvider() {
		return TemplateQuickfixProvider.class;
	}
	...
	public Class<? extends IPartialEditingContentAssistParser> bindIPartialEditingContentAssistParser() {
		return PartialTemplateContentAssistParser.class;
	}
	...
	public void configureCompareViewerTitle(Binder binder) {
		binder.bind(String.class).annotatedWith(Names.named(UIBindings.COMPARE_VIEWER_TITLE)).toInstance("Template Compare");
	}
