 ...
 */
package org.xixum.modeler.spelling.ide.contentassist.antlr;
...
public class NLXParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		@Inject
		public NameMappings(NLXGrammarAccess grammarAccess) {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, NLXGrammarAccess grammarAccess) {
	...
	@Override
	protected InternalNLXParser createParser() {
		InternalNLXParser result = new InternalNLXParser(null);
