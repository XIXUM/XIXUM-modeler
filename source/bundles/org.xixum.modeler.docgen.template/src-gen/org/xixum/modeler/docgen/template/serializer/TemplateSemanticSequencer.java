...
public class TemplateSemanticSequencer extends XbaseWithAnnotationsSemanticSequencer {
	...
	public void sequence(ISerializationContext context, EObject semanticObject) {
		...
		if (epackage == TemplatePackage.eINSTANCE)
			switch (semanticObject.eClass().getClassifierID()) {
			case TemplatePackage.PARAMETER:
				sequence_Parameter(context, (org.xixum.modeler.docgen.template.template.Parameter) semanticObject); 
				return; 
	 ...
	 * </pre>
	 */
	protected void sequence_Parameter(ISerializationContext context, org.xixum.modeler.docgen.template.template.Parameter semanticObject) {
