...
public class TemplateSyntacticSequencer extends AbstractSyntacticSequencer {

	protected TemplateGrammarAccess grammarAccess;
	...
	protected void init(IGrammarAccess access) {
		grammarAccess = (TemplateGrammarAccess) access;
