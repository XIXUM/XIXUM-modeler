...
/**
 * This is the item provider adapter for a {@link org.xixum.latex.texDsl.Attributes} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 TexDslPackage.Literals.ATTRIBUTES__VALUE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addMultiValuePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Attributes_multiValue_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Attributes_multiValue_feature", "_UI_Attributes_type"),
				 TexDslPackage.Literals.ATTRIBUTES__MULTI_VALUE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
