...
*/
    ...
    public InternalNLXParser(TokenStream input, NLXGrammarAccess grammarAccess) {
        this(input);
    ...
    protected String getFirstRuleName() {
   	...
   	@Override
   	protected NLXGrammarAccess getGrammarAccess() {
		...
		(
			...
			lv_sentences_0_0=ruleSentenceType
			{
				...
				add(
					...
					"sentences",
					lv_sentences_0_0,
					"org.xixum.modeler.spelling.NLX.SentenceType");
			...
			(
				...
				lv_pEnd_4_0=ruleParagraph
				{
					...
					set(
						...
						"pEnd",
						lv_pEnd_4_0,
						"org.xixum.modeler.spelling.NLX.Paragraph");
					afterParserOrEnumRuleCall();
				}
			)
		)
		...
		(
			...
			lv_block_0_0=ruleBlockElement
			{
				...
				add(
					...
					"block",
					lv_block_0_0,
					"org.xixum.modeler.spelling.NLX.BlockElement");
				afterParserOrEnumRuleCall();
			}
		)
	)+
			...
			(
				...
				lv_number_0_0=rulesimpleNum
				{
					...
					set(
						...
						"number",
						lv_number_0_0,
						"org.xixum.modeler.spelling.NLX.simpleNum");
					afterParserOrEnumRuleCall();
				}
			)
		)
			...
			(
				...
				lv_SentenceChain_2_0=ruleSentenceChain
				{
					...
					set(
						...
						"org.xixum.modeler.spelling.NLX.SentenceChain");
					afterParserOrEnumRuleCall();
				}
			)
		)
		...
		(
			...
			}
			{
				...
				setWithLastConsumed(
					...
					"content",
					lv_content_0_0,
					"org.xixum.modeler.spelling.NLX.TABLE_LINE");
			}
		)
	)
;
			...
			(
				...
				lv_content_1_0=ruleTableBorder
				{
					...
					add(
						...
						"content",
						lv_content_1_0,
						"org.xixum.modeler.spelling.NLX.TableBorder");
					afterParserOrEnumRuleCall();
				}
			)
		)
			...
			(
				...
				lv_content_2_0=ruleLineSentenceChain
				{
					...
					add(
						...
						"content",
						lv_content_2_0,
						"org.xixum.modeler.spelling.NLX.LineSentenceChain");
					afterParserOrEnumRuleCall();
				}
			)
		)?
		...
		(
			...
			}
			{
				...
				setWithLastConsumed(
					...
					"char",
					lv_char_0_0,
					"org.xixum.modeler.spelling.NLX.HORIZ_SEP");
			}
		)
	)
;
			...
			(
				...
				lv_lines_0_0=ruleTableLine
				{
					...
					add(
						...
						"lines",
						lv_lines_0_0,
						"org.xixum.modeler.spelling.NLX.TableLine");
					afterParserOrEnumRuleCall();
				}
			)
		)
				...
				(
					...
					lv_lines_2_0=ruleTableRow
					{
						...
						add(
							...
							"lines",
							lv_lines_2_0,
							"org.xixum.modeler.spelling.NLX.TableRow");
						afterParserOrEnumRuleCall();
					}
				)
			)
			...
			(
				...
				lv_sentences_1_0=ruleLineSentence
				{
					...
					add(
						...
						"sentences",
						lv_sentences_1_0,
						"org.xixum.modeler.spelling.NLX.LineSentence");
					afterParserOrEnumRuleCall();
				}
			)
		)
				...
				(
					...
					}
					{
						...
						addWithLastConsumed(
							...
							"separators",
							lv_separators_2_0,
							"org.xixum.modeler.spelling.NLX.FULL_STOP_IM");
					}
				)
			)
			(
			...
			(
				...
				lv_sentences_1_0=ruleSentence
				{
					...
					add(
						...
						"sentences",
						lv_sentences_1_0,
						"org.xixum.modeler.spelling.NLX.Sentence");
					afterParserOrEnumRuleCall();
				}
			)
		)
				...
				(
					...
					lv_sentences_3_0=ruleSentenceX
					{
						...
						add(
							...
							"sentences",
							lv_sentences_3_0,
							"org.xixum.modeler.spelling.NLX.SentenceX");
						afterParserOrEnumRuleCall();
					}
				)
			)
				...
				(
					...
					}
					{
						...
						setWithLastConsumed(
							...
							"endpoint",
							lv_endpoint_4_0,
							"org.xixum.modeler.spelling.NLX.FULL_STOP_NL");
					}
				)
			)
			    |
				...
				(
					...
					}
					{
						...
						setWithLastConsumed(
							...
							"endpoint",
							lv_endpoint_5_0,
							"org.xixum.modeler.spelling.NLX.NEWLINE");
					}
				)
			)
		)
					...
					(
						...
						}
						{
							...
							setWithLastConsumed(
								...
								"endpoint",
								lv_endpoint_6_0,
								"org.xixum.modeler.spelling.NLX.KOMMA");
						}
					)
				)
			)
			...
			(
				...
				lv_subsentence_1_0=ruleSubSentence
				{
					...
					add(
						...
						"subsentence",
						lv_subsentence_1_0,
						"org.xixum.modeler.spelling.NLX.SubSentence");
					afterParserOrEnumRuleCall();
				}
			)
		)
				...
				(
					...
					lv_subsentence_3_0=ruleTrailSubSentence
					{
						...
						add(
							...
							"subsentence",
							lv_subsentence_3_0,
							"org.xixum.modeler.spelling.NLX.TrailSubSentence");
						afterParserOrEnumRuleCall();
					}
				)
			)
			...
			(
				...
				lv_subsentence_1_0=ruleLineSubSentence
				{
					...
					add(
						...
						"subsentence",
						lv_subsentence_1_0,
						"org.xixum.modeler.spelling.NLX.LineSubSentence");
					afterParserOrEnumRuleCall();
				}
			)
		)
			...
			(
				...
				lv_subsentence_1_0=ruleFreeSubSentence
				{
					...
					add(
						...
						"subsentence",
						lv_subsentence_1_0,
						"org.xixum.modeler.spelling.NLX.FreeSubSentence");
					afterParserOrEnumRuleCall();
				}
			)
		)
			...
			(
				...
				lv_listpoint_0_0=ruleListPoint
				{
					...
					set(
						...
						"listpoint",
						lv_listpoint_0_0,
						"org.xixum.modeler.spelling.NLX.ListPoint");
					afterParserOrEnumRuleCall();
				}
			)
		)
				...
				(
					...
					lv_SentenceChain_1_0=ruleSentenceChainX
					{
						...
						set(
							...
							"org.xixum.modeler.spelling.NLX.SentenceChainX");
						afterParserOrEnumRuleCall();
					}
				)
			)
				...
				(
					...
					lv_chapterNumber_0_0=ruleChapter_Unit_Low
					{
						...
						set(
							...
							"org.xixum.modeler.spelling.NLX.Chapter_Unit_Low");
						afterParserOrEnumRuleCall();
					}
				)
			)
				...
				(
					...
					lv_chapterNumber_1_0=ruleChapterAlpha
					{
						...
						set(
							...
							"org.xixum.modeler.spelling.NLX.ChapterAlpha");
						afterParserOrEnumRuleCall();
					}
				)
			)
				...
				(
					...
					lv_chapterNumber_2_0=ruleChapter_Unit_HI
					{
						...
						set(
							...
							"org.xixum.modeler.spelling.NLX.Chapter_Unit_HI");
						afterParserOrEnumRuleCall();
					}
				)
			)
					...
					(
						...
						lv_elements_1_0=ruleNoNElement
						{
							...
							add(
								...
								"elements",
								lv_elements_1_0,
								"org.xixum.modeler.spelling.NLX.NoNElement");
							afterParserOrEnumRuleCall();
						}
					)
				)
						...
						(
							...
							lv_elements_3_0=ruleElements
							{
								...
								add(
									...
									"elements",
									lv_elements_3_0,
									"org.xixum.modeler.spelling.NLX.Elements");
								afterParserOrEnumRuleCall();
							}
						)
					)
					...
					(
						...
						lv_elements_4_0=ruleNoNElementX
						{
							...
							add(
								...
								"elements",
								lv_elements_4_0,
								"org.xixum.modeler.spelling.NLX.NoNElementX");
							afterParserOrEnumRuleCall();
						}
					)
				)
				...
				(
					...
					lv_elements_8_0=ruleNew_Line
					{
						...
						add(
							...
							"elements",
							lv_elements_8_0,
							"org.xixum.modeler.spelling.NLX.New_Line");
						afterParserOrEnumRuleCall();
					}
				)
			)
				...
				(
					...
					lv_elements_10_0=ruleNoNElementX2
					{
						...
						add(
							...
							"elements",
							lv_elements_10_0,
							"org.xixum.modeler.spelling.NLX.NoNElementX2");
						afterParserOrEnumRuleCall();
					}
				)
			)
			...
			(
				...
				lv_elements_3_0=ruleAllElements
				{
					...
					add(
						...
						"elements",
						lv_elements_3_0,
						"org.xixum.modeler.spelling.NLX.AllElements");
					afterParserOrEnumRuleCall();
				}
			)
		)
			...
			(
				...
				}
				{
					...
					setWithLastConsumed(
						...
						"open",
						lv_open_1_0,
						"org.xixum.modeler.spelling.NLX.BR_O");
				}
			)
		)
		(
				...
				(
					...
					lv_brackedSentences_2_0=ruleFreeSentence
					{
						...
						add(
							...
							"org.xixum.modeler.spelling.NLX.FreeSentence");
						afterParserOrEnumRuleCall();
					}
				)
			)
					...
					(
						...
						lv_separator_3_0=ruleFullStop
						{
							...
							add(
								...
								"separator",
								lv_separator_3_0,
								"org.xixum.modeler.spelling.NLX.FullStop");
							afterParserOrEnumRuleCall();
						}
					)
				)
				...
				(
					...
					}
					{
						...
						addWithLastConsumed(
							...
							"separator",
							lv_separator_5_1,
							"org.xixum.modeler.spelling.NLX.DOT");
					}
					    |
					...
					}
					{
						...
						addWithLastConsumed(
							...
							"separator",
							lv_separator_5_2,
							"org.xixum.modeler.spelling.NLX.FS");
					}
					    |
					{
			...
			(
				...
				}
				{
					...
					setWithLastConsumed(
						...
						"close",
						lv_close_9_0,
						"org.xixum.modeler.spelling.NLX.BR_CL");
				}
			)
		)
	)
			...
			(
				...
				}
				{
					...
					setWithLastConsumed(
						...
						"open",
						lv_open_1_0,
						"org.xixum.modeler.spelling.NLX.EXBR_O");
				}
			)
		)
		(
			...
			(
				...
				}
				{
					...
					setWithLastConsumed(
						...
						"close",
						lv_close_7_0,
						"org.xixum.modeler.spelling.NLX.EXBR_CL");
				}
			)
		)
	)
			...
			(
				...
				}
				{
					...
					setWithLastConsumed(
						...
						"open",
						lv_open_1_0,
						"org.xixum.modeler.spelling.NLX.EXBRC_O");
				}
			)
		)
		(
			...
			(
				...
				}
				{
					...
					setWithLastConsumed(
						...
						"close",
						lv_close_7_0,
						"org.xixum.modeler.spelling.NLX.EXBRC_CL");
				}
			)
		)
	)
				...
				(
					...
					lv_word_0_0=ruleFragmentX
					{
						...
						add(
							...
							"word",
							lv_word_0_0,
							"org.xixum.modeler.spelling.NLX.FragmentX");
						afterParserOrEnumRuleCall();
					}
				)
			)
						...
						(
							...
							lv_word_1_0=ruleFragment
							{
								...
								add(
									...
									"word",
									lv_word_1_0,
									"org.xixum.modeler.spelling.NLX.Fragment");
								afterParserOrEnumRuleCall();
							}
						)
					)
						...
						(
							...
							lv_word_2_0=ruleSeparatorsL
							{
								...
								add(
									...
									"word",
									lv_word_2_0,
									"org.xixum.modeler.spelling.NLX.SeparatorsL");
								afterParserOrEnumRuleCall();
							}
						)
					)
			...
			(
				...
				}
				{
					...
					addWithLastConsumed(
						...
						"word",
						lv_word_1_0,
						"org.xixum.modeler.spelling.NLX.ALPHA");
				}
			)
		)
	)
								...
								(
									...
									lv_word_0_0=ruleSeparatorsIt
									{
										...
										add(
											...
											"word",
											lv_word_0_0,
											"org.xixum.modeler.spelling.NLX.SeparatorsIt");
										afterParserOrEnumRuleCall();
									}
								)
							)+
								...
								(
									...
									lv_word_1_0=ruleHashP
									{
										...
										add(
											...
											"word",
											lv_word_1_0,
											"org.xixum.modeler.spelling.NLX.HashP");
										afterParserOrEnumRuleCall();
									}
								)
							)
								...
								(
									...
									}
									{
										...
										addWithLastConsumed(
											...
											"word",
											lv_word_2_0,
											"org.xixum.modeler.spelling.NLX.MULTI");
									}
								)
							)
							    |
								...
								(
									...
									}
									{
										...
										addWithLastConsumed(
											...
											"word",
											lv_word_3_0,
											"org.xixum.modeler.spelling.NLX.CURRENCY");
									}
								)
							)
						)
								...
								(
									...
									lv_word_4_0=ruleItWordElXx
									{
										...
										add(
											...
											"word",
											lv_word_4_0,
											"org.xixum.modeler.spelling.NLX.ItWordElXx");
										afterParserOrEnumRuleCall();
									}
								)
							)
							...
							(
								...
								lv_word_6_0=ruleItWordEl
								{
									...
									add(
										...
										"word",
										lv_word_6_0,
										"org.xixum.modeler.spelling.NLX.ItWordEl");
									afterParserOrEnumRuleCall();
								}
							)
						)
							...
							(
								...
								}
								{
									...
									addWithLastConsumed(
										...
										"word",
										lv_word_7_0,
										"org.xixum.modeler.spelling.NLX.CURL");
								}
							)
						)
						    |
								...
								(
									...
									}
									{
										...
										addWithLastConsumed(
											...
											"word",
											lv_word_8_0,
											"org.xixum.modeler.spelling.NLX.ALL_ALPHA");
									}
								)
							)
							(
								(
									...
									}
									{
										...
										addWithLastConsumed(
											...
											"word",
											lv_word_9_0,
											"org.xixum.modeler.spelling.NLX.COLON");
									}
								)
							)
						)
						...
						(
							...
							lv_word_10_0=ruleAllSep
							{
								...
								add(
									...
									"word",
									lv_word_10_0,
									"org.xixum.modeler.spelling.NLX.AllSep");
								afterParserOrEnumRuleCall();
							}
						)
					)+
						...
						(
							...
							lv_word_13_0=ruleAsterisk
							{
								...
								add(
									...
									"word",
									lv_word_13_0,
									"org.xixum.modeler.spelling.NLX.Asterisk");
								afterParserOrEnumRuleCall();
							}
						)
					)
							...
							(
								...
								lv_word_17_0=ruleItWordElX
								{
									...
									add(
										...
										"word",
										lv_word_17_0,
										"org.xixum.modeler.spelling.NLX.ItWordElX");
									afterParserOrEnumRuleCall();
								}
							)
						)
		...
		(
			...
			}
			{
				...
				setWithLastConsumed(
					...
					"quote",
					lv_quote_0_0,
					"org.xixum.modeler.spelling.NLX.STRING");
			}
		)
	)
;
			...
			(
				...
				}
				{
					...
					setWithLastConsumed(
						...
						"signature",
						lv_signature_0_0,
						"org.xixum.modeler.spelling.NLX.MINUS");
				}
			)
		)?
		(
			...
			(
				...
				lv_value_1_0=ruleNumber
				{
					...
					add(
						...
						"value",
						lv_value_1_0,
						"org.xixum.modeler.spelling.NLX.Number");
					afterParserOrEnumRuleCall();
				}
			)
		)
				...
				(
					...
					}
					{
						...
						setWithLastConsumed(
							...
							"unit",
							lv_unit_3_0,
							"org.xixum.modeler.spelling.NLX.ID");
					}
				)
			)
			    |
				...
				(
					...
					}
					{
						...
						setWithLastConsumed(
							...
							"unit",
							lv_unit_4_0,
							"org.xixum.modeler.spelling.NLX.PERCENT");
					}
				)
			)
		)?
				...
				(
					...
					lv_value_1_0=rulechapterNum
					{
						...
						add(
							...
							"value",
							lv_value_1_0,
							"org.xixum.modeler.spelling.NLX.chapterNum");
						afterParserOrEnumRuleCall();
					}
				)
			)
			...
			(
				...
				lv_value_2_0=ruleItNum
				{
					...
					add(
						...
						"value",
						lv_value_2_0,
						"org.xixum.modeler.spelling.NLX.ItNum");
					afterParserOrEnumRuleCall();
				}
			)
		)
			...
			(
				...
				}
				{
					...
					addWithLastConsumed(
						...
						"value",
						lv_value_3_0,
						"org.xixum.modeler.spelling.NLX.HEX_NUMBER");
				}
			)
		)
	)
			...
			(
				...
				lv_value_1_0=ruledecimalNumEN
				{
					...
					add(
						...
						"value",
						lv_value_1_0,
						"org.xixum.modeler.spelling.NLX.decimalNumEN");
					afterParserOrEnumRuleCall();
				}
			)
		)
				...
				(
					...
					}
					{
						...
						setWithLastConsumed(
							...
							"sign",
							lv_sign_1_1,
							"org.xixum.modeler.spelling.NLX.HASH");
					}
					    |
					...
					}
					{
						...
						setWithLastConsumed(
							...
							"sign",
							lv_sign_1_2,
							"org.xixum.modeler.spelling.NLX.PARAGR");
					}
				)
			)
		)
				...
				(
					...
					}
					{
						...
						addWithLastConsumed(
							...
							"value",
							lv_value_1_0,
							"org.xixum.modeler.spelling.NLX.ID_C");
					}
				)
			)
			    |
			...
			(
				...
				lv_value_4_0=ruleChapterIntermediate
				{
					...
					add(
						...
						"value",
						lv_value_4_0,
						"org.xixum.modeler.spelling.NLX.ChapterIntermediate");
					afterParserOrEnumRuleCall();
				}
			)
		)
			...
			(
				...
				lv_symbol_1_0=ruleSpecialSymbols
				{
					...
					set(
						...
						"symbol",
						lv_symbol_1_0,
						"org.xixum.modeler.spelling.NLX.SpecialSymbols");
					afterParserOrEnumRuleCall();
				}
			)
		)
			...
			(
				...
				lv_symbol_1_0=ruleSpecialCh
				{
					...
					set(
						...
						"symbol",
						lv_symbol_1_0,
						"org.xixum.modeler.spelling.NLX.SpecialCh");
					afterParserOrEnumRuleCall();
				}
			)
		)
			...
			(
				...
				}
				{
					...
					setWithLastConsumed(
						...
						"shortcut",
						lv_shortcut_1_0,
						"org.xixum.modeler.spelling.NLX.SHORTCUTS");
				}
			)
		)
	)
			...
			(
				...
				lv_shortcut_0_0=ruleShortcutLib
				{
					...
					set(
						...
						"shortcut",
						lv_shortcut_0_0,
						"org.xixum.modeler.spelling.NLX.ShortcutLib");
					afterParserOrEnumRuleCall();
				}
			)
		)
			...
			(
				...
				lv_shortcut_1_0=ruleShortcutGen
				{
					...
					set(
						...
						"shortcut",
						lv_shortcut_1_0,
						"org.xixum.modeler.spelling.NLX.ShortcutGen");
					afterParserOrEnumRuleCall();
				}
			)
		)
		...
		(
			...
			}
			{
				...
				setWithLastConsumed(
					...
					"ignored",
					lv_ignored_0_0,
					"org.xixum.modeler.spelling.NLX.IGNORED");
			}
		)
	)
;
			...
			(
				...
				}
				{
					...
					setWithLastConsumed(
						...
						"protocol",
						lv_protocol_0_0,
						"org.xixum.modeler.spelling.NLX.URL_PROTOCOL");
				}
			)
		)
		(
			(
				...
				lv_url_1_0=ruleItWordElurl
				{
					...
					add(
						...
						"url",
						lv_url_1_0,
						"org.xixum.modeler.spelling.NLX.ItWordElurl");
					afterParserOrEnumRuleCall();
				}
			)
		)
		...
		(
			...
			}
			{
				...
				addWithLastConsumed(
					...
					"email",
					lv_email_0_0,
					"org.xixum.modeler.spelling.NLX.AT");
			}
		)
	)
;
				...
				(
					...
					lv_email_0_0=ruleItWord
					{
						...
						add(
							...
							"email",
							lv_email_0_0,
							"org.xixum.modeler.spelling.NLX.ItWord");
						afterParserOrEnumRuleCall();
					}
				)
			)
				...
				(
					...
					lv_email_1_0=ruleWord
					{
						...
						add(
							...
							"email",
							lv_email_1_0,
							"org.xixum.modeler.spelling.NLX.Word");
						afterParserOrEnumRuleCall();
					}
				)
			)
			...
			(
				...
				lv_email_2_0=ruleEmailAT
				{
					...
					add(
						...
						"email",
						lv_email_2_0,
						"org.xixum.modeler.spelling.NLX.EmailAT");
					afterParserOrEnumRuleCall();
				}
			)
		)
			...
			(
				...
				lv_parameters_3_0=ruleBracketSentence
				{
					...
					add(
						...
						"parameters",
						lv_parameters_3_0,
						"org.xixum.modeler.spelling.NLX.BracketSentence");
					afterParserOrEnumRuleCall();
				}
			)
		)
			...
			(
				...
				lv_parameters_2_0=ruleExtBracketSentence
				{
					...
					add(
						...
						"parameters",
						lv_parameters_2_0,
						"org.xixum.modeler.spelling.NLX.ExtBracketSentence");
					afterParserOrEnumRuleCall();
				}
			)
		)+
