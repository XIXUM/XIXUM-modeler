...
public class InternalTexDslParser extends AbstractInternalContentAssistParser {
    public static final String[] tokenNames = new String[] {
        "<invalid>", "<EOR>", "<DOWN>", "<UP>", "RULE_ID", "RULE_ALPHA_NUMERIC", "RULE_END", "RULE_SQBO", "RULE_SQBC", "RULE_KOMMA", "RULE_CUBO", "RULE_CUBC", "RULE_EQ", "RULE_BS", "RULE_ML_COMMENT", "RULE_SL_COMMENT", "RULE_SYMBOL", "RULE_SYMBOLS", "RULE_ALPHA", "RULE_NUMERIC", "RULE_DOT", "RULE_AND", "RULE_ALPHAC", "RULE_ALPHAS", "RULE_BO", "RULE_BC", "RULE_INT", "RULE_STRING", "RULE_WS", "RULE_ANY_OTHER"
    };
    ...
    // InternalTexDsl.g:1096:1: rule__Attributes__KeyAssignment_0 : ( ruleID_Token ) ;
    public final void rule__Attributes__KeyAssignment_0() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalTexDsl.g:1100:1: ( ( ruleID_Token ) )
            // InternalTexDsl.g:1101:2: ( ruleID_Token )
            {
            // InternalTexDsl.g:1101:2: ( ruleID_Token )
            // InternalTexDsl.g:1102:3: ruleID_Token
            {
    ...
    public static final BitSet FOLLOW_8 = new BitSet(new long[]{0x0000000000000300L});
