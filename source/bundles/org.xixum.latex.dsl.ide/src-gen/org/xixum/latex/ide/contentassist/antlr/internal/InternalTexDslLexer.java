...
public class InternalTexDslLexer extends Lexer {
    ...
    public final void mRULE_NUMBER() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalTexDsl.g:1558:13: ( RULE_INT ( '.' RULE_INT )? )
            // InternalTexDsl.g:1558:15: RULE_INT ( '.' RULE_INT )?
            {
            mRULE_INT(); 
            // InternalTexDsl.g:1558:24: ( '.' RULE_INT )?
            int alt1=2;
            ...
            switch (alt1) {
                case 1 :
                    // InternalTexDsl.g:1558:25: '.' RULE_INT
                    {
                    match('.'); 
                    mRULE_INT(); 
    ...
    public final void mRULE_SYMBOL() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalTexDsl.g:1560:13: ( ( '+' | '-' | '=' | '/' | '*' | '^' | '_' | '<' | '>' | '&' | '%' | '#' ) )
            // InternalTexDsl.g:1560:15: ( '+' | '-' | '=' | '/' | '*' | '^' | '_' | '<' | '>' | '&' | '%' | '#' )
            {
    ...
    public final void mRULE_TEXT() throws RecognitionException {
        try {
            int _type = RULE_TEXT;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalTexDsl.g:1562:11: ( (~ ( ( '\\\\' | '$' | '{' | '}' | '[' | ']' | '^' | '_' | ' ' | '\\t' | '\\r' | '\\n' ) ) )+ )
            // InternalTexDsl.g:1562:13: (~ ( ( '\\\\' | '$' | '{' | '}' | '[' | ']' | '^' | '_' | ' ' | '\\t' | '\\r' | '\\n' ) ) )+
            {
            // InternalTexDsl.g:1562:13: (~ ( ( '\\\\' | '$' | '{' | '}' | '[' | ']' | '^' | '_' | ' ' | '\\t' | '\\r' | '\\n' ) ) )+
            int cnt2=0;
            loop2:
    ...
    public final void mRULE_SL_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalTexDsl.g:1564:17: ( '%' (~ ( ( '\\n' | '\\r' ) ) )* ( ( '\\r' )? '\\n' )? )
            // InternalTexDsl.g:1564:19: '%' (~ ( ( '\\n' | '\\r' ) ) )* ( ( '\\r' )? '\\n' )?
            {
            match('%'); 
            // InternalTexDsl.g:1564:23: (~ ( ( '\\n' | '\\r' ) ) )*
            loop3:
            do {
                int alt3=2;
    ...
    public final void mRULE_WS() throws RecognitionException {
        try {
            int _type = RULE_WS;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalTexDsl.g:1566:9: ( ( ' ' | '\\t' | '\\r' | '\\n' )+ )
            // InternalTexDsl.g:1566:11: ( ' ' | '\\t' | '\\r' | '\\n' )+
            {
            // InternalTexDsl.g:1566:11: ( ' ' | '\\t' | '\\r' | '\\n' )+
            int cnt6=0;
            loop6:
    ...
    public final void mRULE_INT() throws RecognitionException {
        try {
            // InternalTexDsl.g:1568:19: ( ( '0' .. '9' )+ )
            // InternalTexDsl.g:1568:21: ( '0' .. '9' )+
            {
            // InternalTexDsl.g:1568:21: ( '0' .. '9' )+
            int cnt7=0;
            loop7:
    ...
    public final void mRULE_ID() throws RecognitionException {
        try {
            int _type = RULE_ID;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalTexDsl.g:1570:9: ( ( '^' )? ( 'a' .. 'z' | 'A' .. 'Z' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )* )
            // InternalTexDsl.g:1570:11: ( '^' )? ( 'a' .. 'z' | 'A' .. 'Z' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )*
            {
            // InternalTexDsl.g:1570:11: ( '^' )?
            int alt8=2;
            ...
            // InternalTexDsl.g:1570:40: ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )*
            loop9:
            do {
                int alt9=2;
    ...
    public final void mRULE_END() throws RecognitionException {
        try {
            int _type = RULE_END;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalTexDsl.g:1572:10: ( EOF )
            // InternalTexDsl.g:1572:12: EOF
            {
            match(EOF); 
